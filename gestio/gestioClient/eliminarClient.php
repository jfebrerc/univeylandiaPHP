    ...
    <div class="row">
        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <ul class="nav flex-column collapse show" id="submenu1" data-parent="#sidebar">
              ...
              <li class="nav-item">
                <a class="nav-link nav-interior active" href="../gestioClient/eliminarClient.html"><span data-feather="user-minus"></span>Eliminar Client</a>
              </li>
            </ul>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Eliminar client</h1>
        </div>
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Eliminar clients de forma massiva</h1>
        </div>
        ...
        <form>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-3 mb-3">
                <label for="exampleFormControlFile1">Pujar arxiu .CSV amb clients a eliminar</label>
