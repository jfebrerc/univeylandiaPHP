    ...
    <div class="row">
        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <ul class="nav flex-column collapse show" id="submenu1" data-parent="#sidebar">
              <li class="nav-item">
                <a class="nav-link nav-interior active" href="../gestioClient/crearClient.html"><span data-feather="user-plus"></span>Crear Client</a>
              </li>
              <li class="nav-item">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form class="needs-validation" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
          ...
          <div class="form-row">
            <div class="col-md-3 mb-3">
              <label for="validationCustom11">Codi postal *</label>
        ...
        <?php
        if(isset($_POST['nom'])) {
          $client = new Client($_POST['nom'],$_POST['cognom1'],$_POST['cognom2'],$_POST['tipus_doc'],$_POST['num_doc'],$_POST['data'],
          $_POST['sexe'],$_POST['tlf'],$_POST['email'],$_POST['adreca'],$_POST['ciutat'],$_POST['provincia'],$_POST['codi_postal']);
