          ...
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <ul class="nav flex-column collapse" id="submenu1" data-parent="#sidebar">
                ...
                <li class="nav-item">
                  <a class="nav-link nav-interior" href="../../gestioClient/llistarClients.html"><span data-feather="file-text"></span>Llistar Clients</a>
                </li>
                <li class="nav-item">
              ...
              <ul class="nav flex-column collapse show" id="submenu4" data-parent="#sidebar">
                <li class="nav-item">
                  ...
                  <ul class="nav flex-column collapse" id="sub-submenu1" data-parent="#submenu4">
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../habitacio/inserirHabitacio.html"><span data-feather="star"></span>Inserir Habitacions</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2"  href="../habitacio/eliminarHabitacio.html"><span data-feather="star"></span>Eliminar Habitacions</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2"  href="../habitacio/modificarHabitacio.html"><span data-feather="star"></span>Modificar Habitacions</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2"  href="../habitacio/consultarHabitacio.html"><span data-feather="star"></span>Consultar Habitacions</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2"  href="../habitacio/llistarHabitacio.html"><span data-feather="star"></span>Llistar Habitacions</a>
                    </li>
                  </ul>
                ...
                <ul class="nav flex-column collapse" id="sub-submenu3" data-parent="#submenu4">
                    <li class="nav-item">
                      <a class="nav-link nav-interior2"  href="../reservaHabitacio/inserirReservaHabitacio.html"><span data-feather="star"></span>Inserir Reserva Hab</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaHabitacio/eliminarReservaHabitacio.html"><span data-feather="star"></span>Eliminar Reserva Hab</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaHabitacio/modificarReservaHabitacio.html"><span data-feather="star"></span>Modificar Reserva Hab</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2 active" href="../reservaHabitacio/consultarReservaHabitacio.html"><span data-feather="star"></span>Consultar Reserva Hab</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaHabitacio/llistarReservaHabitacio.html"><span data-feather="star"></span>Llistar Reserva Hab</a>
                    </li>
                </ul>
                ...
                <ul class="nav flex-column collapse show" id="sub-submenu2" data-parent="#submenu4">
                  <li class="nav-item">
                    <a class="nav-link nav-interior2" href="../restaurant/inserirTaula.html"><span data-feather="star"></span>Inserir Taula</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-interior2 active" href="../restaurant/eliminarTaula.html"><span data-feather="star"></span>Eliminar Taula</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-interior2" href="../restaurant/modificarTaula.html"><span data-feather="star"></span>Modificar Taula</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-interior2" href="../restaurant/consultarTaula.html"><span data-feather="star"></span>Consultar Taula</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-interior2" href="../restaurant/llistarTaula.html"><span data-feather="star"></span>Llistar Taula</a>
                  </li>
                </ul>
                ...
                <ul class="nav flex-column collapse" id="sub-submenu4" data-parent="#submenu4">
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaRestaurant/inserirReservaTaula.html"><span data-feather="star"></span>Inserir Reserva Taula</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaRestaurant/eliminarReservaTaula.html"><span data-feather="star"></span>Eliminar Reserva Taula</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaRestaurant/modificarReservaTaula.html"><span data-feather="star"></span>Modificar Reserva Taula</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaRestaurant/consultarReservaTaula.html"><span data-feather="star"></span>Consultar Reserva Taula</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-interior2" href="../reservaRestaurant/llistarReservaTaula.html"><span data-feather="star"></span>Llistar Reserva Taula</a>
                    </li>
                </ul>
              </ul>
