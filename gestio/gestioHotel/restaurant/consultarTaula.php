            ...
            <ul class="nav flex-column">
              ...
              <ul class="nav flex-column collapse show" id="submenu4" data-parent="#sidebar">
                ...
                <ul class="nav flex-column collapse show" id="sub-submenu2" data-parent="#submenu4">
                  ...
                  <li class="nav-item">
                    <a class="nav-link nav-interior2" href="../restaurant/eliminarTaula.html"><span data-feather="star"></span>Eliminar Taula</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-interior2" href="../restaurant/modificarTaula.html"><span data-feather="star"></span>Modificar Taula</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-interior2 active" href="../restaurant/consultarTaula.html"><span data-feather="star"></span>Consultar Taula</a>
                  </li>
                  <li class="nav-item">
