  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <?php
              include_once $_SERVER['DOCUMENT_ROOT']."/php/class/classeManteniment.php";
              ...
              <div class="col-3">
                ...
                Manteniment::llistarNomAtraccions();
              echo '  </select>
              </div>
              <div class="form-group row">
              ...
              Manteniment::llistarAssignBusqueda($buscar, $buscar_atraccio);
              if (isset($_POST['modificar'])) {
                Manteniment::modificarAssignacio();
                }
              if (isset($_POST['Acceptar'])){
                Manteniment::eliminarAssignacio();
                }
